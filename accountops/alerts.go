// Adapted from Sub2API 2.8.11; LGPL-3.0. See SOURCE.md.
package accountops
...
func (s *AccountOpsService) SetModuleGate(gate func() bool) { s.moduleGate = gate }
func (s *AccountOpsService) moduleEnabled() bool            { return s.moduleGate == nil || s.moduleGate() }
...
func DefaultConfig() AccountOpsConfig { return defaultAccountOpsConfig() }
